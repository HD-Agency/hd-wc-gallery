...
final class GallerySetup {
	...
	public static function enqueueAssets(): void {
		...
		wp_localize_script(
			...
			'hdWcGalleryConfig',
			[
				'jsUrl'  => HD_WC_GALLERY_URL . 'assets/gallery.js',
				'cssUrl' => HD_WC_GALLERY_URL . 'assets/gallery.css',
			]
		);
	}
	...
	/**
	 * Output preload hint for main gallery hero image on single product.
	 */
